...
The vaccine and the placebo had the same effect for people who do not have aids(50% for both). The placebo had more of an effect than the vaccine for people with aids (60% vs. 40%).
...
There is a relationship between the effectiveness of the vaccine and whether the person has aids. People who do not have aids are more likely than people with aids to be effected by the vaccine (50.07% vs. 40.80%). 
...
Ho: There is no relationship between the effectiveness of the vaccine and whether or not the person has aids. 
Ha:There is a relationship between the effectiveness of the vaccine and whether or not the person has aids.
If there is no relationship between the effectiveness of the vaccine and whether or not the person has aids, there is a little less than a 5% chance that we get a chi-square statistic as big as 3.90. Since the p-value 0.048 < 0.05, we reject the null. There is strong evidence that there is a relationship between the effectiveness of the vaccine and whether or not the person has aids. 

## Conclusions

<Summarise your results as to the effectiveness of the vaccine with explanations that could be understood by your mom>

Based on the graphical, numerical and inferential results there is strong evidence that there is a relationship between the effectiveness of the vaccine and whether or not the person has aids. 
